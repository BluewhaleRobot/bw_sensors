...
scene.forward = (-1,0,-0.25)#(1,0,-0.25)
...
# IMU object
platform = box(length=0.65, height=0.05, width=1.5, color=color.red,up=(0,0,1),axis=(-1,0,0))
...
sub = rospy.Subscriber('/bw_sensors/IMU', Imu, processIMU_message)
rospy.spin()
